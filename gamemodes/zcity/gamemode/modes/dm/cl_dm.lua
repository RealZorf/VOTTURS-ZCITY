...
CreateEndMenu = function()
	...
	for i,ply in player.Iterator() do
		...
		but.Paint = function(self,w,h)
			...
			local mvp = validPly and ply.most_violent_player
			local isAlive = validPly and ply:Alive()
			local col1 = ((won or mvp) and colRed) or (isAlive and colBlue) or colGray
            local col2 = ((won or mvp) and colRedUp) or (isAlive and colBlueUp) or colSpect1
			...
			surface.SetFont( "ZB_InterfaceMediumLarge" )
			surface.SetTextColor(col.r,col.g,col.b,col.a)
			local leftText = validPly and (ply:Name() .. (mvp and " - MVP" or (not isAlive and " - died" or ""))) or "He quited..."

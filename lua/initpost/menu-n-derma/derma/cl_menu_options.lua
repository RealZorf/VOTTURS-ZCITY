...
hg.settings:AddOpt("Optimization", "hg_tpik_remote_near_fps", "Nearby players' arm animation FPS", nil, nil, "int", "How often nearby players' weapon arm positions are solved. Higher is smoother but uses more CPU")
hg.settings:AddOpt("Optimization", "hg_tpik_remote_mid_fps", "Mid-range players' arm animation FPS", nil, nil, "int", "How often mid-range players' weapon arm positions are solved. Higher is smoother but uses more CPU")
hg.settings:AddOpt("Optimization", "hg_tpik_remote_far_fps", "Distant players' arm animation FPS", nil, nil, "int", "How often distant players' weapon arm positions are solved. Higher is smoother but uses more CPU")
hg.settings:AddOpt("Optimization", "hg_tpik_remote_near_distance", "Nearby arm animation range", nil, nil, "int", "Distance where remote weapon arms switch from the nearby FPS setting to the mid-range setting")
hg.settings:AddOpt("Optimization", "hg_tpik_remote_mid_distance", "Mid-range arm animation range", nil, nil, "int", "Distance where remote weapon arms switch from the mid-range FPS setting to the distant setting")

...
local mat2 = "models/weapons/tfa_ins2/nova/weapon_m590a1_dm" --I don't know how but it looks cool
...
function SWEP:ReloadEnd()
	...
	self.ReloadNext = CurTime() + self.ReloadCooldown --I don't know what this is
	self:Draw()
end

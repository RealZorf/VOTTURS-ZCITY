...
function SWEP:Reload(time)
	...
	self.StaminaReloadTime = self.StaminaReloadTime * self:GetLMSFinalStandMultiplier()
...
--maybe a little messed up code but it works fine
...
concommand.Add("hg_reloadfloorweapon", function(ply, cmd, args)
	...
	if limbs and clip < maxclip or (ammocount > 0 or (isshotgun and clip > 0 and not ent.drawBullet)) then
		...
		ply:SetNW2Bool("FloorReloading", true) --This is where the failsafe begins..

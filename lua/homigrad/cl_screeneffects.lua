...
--[[hook.Add( "PreDrawHalos", "AddPropHalos", function() -- variant: highlight everything in radius
	local pickuphalo = {}
...
--[[hook.Add( "PreDrawHalos", "AddPropHalos", function() -- variant: highlight only while looking at it
	local pickuphalo = {}
